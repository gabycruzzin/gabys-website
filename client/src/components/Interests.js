    ...
    <>
      <div className="flex-container">
        <div className="flex-item-left">
          ...
          <p>
            Me and my boyfriend Jake take care of these many different species
            of cacti - it took a lot of trial and error.
          </p>
          <p>
            These guys are dangerous, let me tell you. Have to be really careful
            when re-potting them.
          </p>
          <p>
            Never thought we would have any kind of plants... but they're so fun
            to watch grow! Plus, they need VERY little water.
          </p>
        </div>
      ...
      <div className="flex-container">
        <div className="flex-item-left">
          ...
          <p>
            I whip out my baking skills when the holidays come around or for
            birthdays.
          </p>
        </div>
        <div className="flex-item-right">
      ...
      <div className="flex-container">
        <div className="flex-item-left">
          ...
          <p>
            Tools used: Photoshop, Silhouette Cameo (cutting machine), Wacom
            tablet, HP Envy Photo printer
          </p>
